...
if (isset($_POST['btn_save_2'])) {
    ...
    if (empty($blogtitle)) { $errors[] = "Article Title is required."; }
    if (strlen($blogtitle) > 150) { $errors[] = "Article Title cannot exceed 150 characters."; }
    if (empty($blogcategory)) { $errors[] = "Category is required."; }
    if (empty($blogdiscription)) { $errors[] = "Description is required."; }
    if (strlen($blogdiscription) > 5000) { $errors[] = "Description is too long (max 5000 characters)."; }
...
.char-counter { font-size: 0.8em; color: #6c757d; text-align: right; }
</style>
        ...
        <div class="row">
            <div class="col">
                ...
                <?php if (!empty($_SESSION['form_success'])): ?>
                    <div class="alert alert-success"><?php echo $_SESSION['form_success']; unset($_SESSION['form_success']); ?></div>
                <?php endif; ?>
                <?php if (!empty($errors)): ?>
...
<div class="col-lg-12 col-sm-12 d-flex flex-column mb-30">
    ...
    <textarea name="Descriptionusrblog" id="descriptionsblogs" rows="20"></textarea>
                        ...
                        <div class="col-12 mb-2 fos-16"><hr><h5>Social/Portfolio Links (Optional)</h5></div>
