<section class="container bg-[url(/assets/images/hero-image.svg)] min-w-full">
    <div class="hero-sec  d-flex justify-content-center align-items-center">
        <div class="row">
            <div class="flex justify-center items-center flex-col">
                ...
                <div
                    class="d-flex justify-content-center 2xl:w-full head-searching-content align-items-md-center align-items-start flex-column flex-md-row xs:w-[75%]" id="search-form">
