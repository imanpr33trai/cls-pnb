...
if ($stmt->execute()) {
    if ($stmt->affected_rows > 0) {
       ...
       if ($conn->errno === 1451) {         echo json_encode(['success' => false, 'message' => 'Cannot delete user. They may have active ads or other associated data. Please reassign or delete their content first.']);
    } else {
