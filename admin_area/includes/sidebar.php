...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="dropdown">
        <button onclick="myFunction()" class="dropbtn"><i class="fa fa-user"></i>
            <?php echo $admin_name; ?></a></button>
        ...
        <a href="index.php?view_product_cat">view Product Categories</a>
            ...
            <li class="button-dropdown" id="#category">
                <a href="#" class="dropdown-toggle" data-toggle="collapse" data-target="#category"><i
                        class="fa fa-fw fa-table"></i> Categories <i class="fa fa-fw fa-caret-down"></i></a>
            ...
            <li class="button-dropdown" id="#category">
                <a href="#" class="dropdown-toggle" data-toggle="collapse" data-target="#bcategory"><i
                        class="fa fa-fw fa-table"></i> Blog Categories <i class="fa fa-fw fa-caret-down"></i></a>

                <ul id="#bcategory" class="dropdown-menu">
                    <li>
                        <a href="index.php?insert_blog_cat">Insert Blog Category</a>
                    </li>
                    <li>
                        <a href="index.php?view_blog_cat">view Blog Category</a>
                    </li>
                </ul>
            </li>
            ...
            <!-- <li class="button-dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="collapse" data-target="#slider"><i
                        class="fa fa-fw fa-table"></i> Slider <i class="fa fa-fw fa-caret-down"></i></a>
            ...
            <li class="button-dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="collapse" data-target="#users"><i
                        class="fa fa-fw fa-table"></i> Users <i class="fa fa-fw fa-caret-down"></i></a>
